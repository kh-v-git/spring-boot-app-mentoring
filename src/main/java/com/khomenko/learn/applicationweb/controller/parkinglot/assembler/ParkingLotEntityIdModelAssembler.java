...
@Component
public class ParkingLotEntityIdModelAssembler implements RepresentationModelAssembler<ParkingLotEntity, EntityModel<ParkingLotEntity>> {
    @Override
    public EntityModel<ParkingLotEntity> toModel(final ParkingLotEntity lot) {
        return EntityModel.of(lot, linkTo(methodOn(ParkingLotController.class).getParkingLotById(lot.getId())).withSelfRel(),
